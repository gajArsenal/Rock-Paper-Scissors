...
int main(){
	...
	while(gamePlaying == true){
		...
		cout << "Player Two (Computer): " << endl;
		answerTwo = getRandomChoice();
		cout << answerTwo << endl;
...
string getRandomChoice(){
	...
	//cout << randomizer.max() << endl;
	
	unsigned long chosenNumber = randomizer.max() - randomizer();
	
	unsigned long third = randomizer.max() * 0.33;
	unsigned long two_thirds = randomizer.max() * 0.67;
	//cout << "initial: " << chosenNumber << endl;
	//cout << "third: " << third << endl;
	//cout << "two_thirds: " << two_thirds << endl;
	
	int returnValue = 1;
	
	if(chosenNumber < third){
		//cout << "less than third" << endl;
		returnValue = 0;
		return "rock";
	}
	if(chosenNumber > two_thirds){
		//cout << "greater than two thirds" << endl;
		returnValue = 2;
		return "scissors";
	}
